...
void RF24::printDetails(void)
{
  ...
  SERIAL("Data Rate\t = %s\r\n",_pgm_read_word(&rf24_datarate_e_str_P[getDataRate()]));
  SERIAL("Model\t\t = %s\r\n",_pgm_read_word(&rf24_model_e_str_P[isPVariant()]));
  SERIAL("CRC Length\t = %s\r\n",_pgm_read_word(&rf24_crclength_e_str_P[getCRCLength()]));
  SERIAL("PA Power\t = %s\r\n",_pgm_read_word(&rf24_pa_dbm_e_str_P[getPALevel()]));
